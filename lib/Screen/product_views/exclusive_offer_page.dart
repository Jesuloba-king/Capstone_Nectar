...
class ExclusiveOfferPage extends StatefulWidget {
  const ExclusiveOfferPage({super.key, required this.currentUserId});

  final String currentUserId;

  @override
  State<ExclusiveOfferPage> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<ExclusiveOfferPage> {
