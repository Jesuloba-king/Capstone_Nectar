...
class ELectronicsPage extends StatefulWidget {
  const ELectronicsPage({super.key, required this.currentUserId});

  final String currentUserId;

  @override
  State<ELectronicsPage> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<ELectronicsPage> {
