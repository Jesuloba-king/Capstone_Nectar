...
class _DetailScreenState extends State<DetailScreen> {
  ...
  getDetail() async {
    ...
    final data = await ApiService().getProductsDetails(widget.id);
    setState(() {
      productModel = data!;
      isLoading = false;
      if (kDebugMode) {
  ...
  Future fetchCategory([howMany = 5]) async {
    var url = Uri.parse(ApiConstants.productCategoryBaseUrl + widget.category);
                            ...
                            Row(
                              children: [
                                ...
                                RatingBar.builder(
                                  ...
                                  itemCount:
                                      (productModel.rating!.rate).toInt(),
                                  itemSize: 20,
