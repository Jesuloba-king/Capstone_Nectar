...
class WomenClothingPage extends StatefulWidget {
  const WomenClothingPage({super.key, required this.currentUserId});

  final String currentUserId;

  @override
  State<WomenClothingPage> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<WomenClothingPage> {
  ...
  Future fetchPost([howMany = 5]) async {
    var url =
        Uri.parse(ApiConstants.womenClothingBaseUrl + ApiConstants().cloth);
