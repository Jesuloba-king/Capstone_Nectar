...
class MensClothingPage extends StatefulWidget {
  const MensClothingPage({super.key, required this.currentUserId});

  final String currentUserId;

  @override
  State<MensClothingPage> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<MensClothingPage> {
  ...
  Future fetchPost([howMany = 5]) async {
    var url = Uri.parse(ApiConstants.menClothingBaseUrl + ApiConstants().cloth);
